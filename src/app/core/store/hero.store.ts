...
export class HeroStore {
  ...
  addHero(hero: Omit<Hero, 'id'>): Hero {
    if (!hero.name || !hero.alterEgo || !hero.powers.length || !hero.publisher || !hero.firstAppearance) {
      throw new Error('Invalid hero: missing required fields');
    }
